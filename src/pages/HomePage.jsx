...
const CATEGORIES = [
  { name: "Tandoori & Grills", desc: "Smoked slow, finished on open flame.", image: "/images/dish-wings.png" },
  { name: "Rice & Biryani", desc: "Layered, dum-cooked, always fragrant.", image: "/images/dish-biryani.png" },
  { name: "Curry House", desc: "Slow-simmered gravies, house spice blends.", image: "/images/dish-thali.png" },
];
...
export default function HomePage() {
  ...
  return (
    <div className="ieyal min-h-screen w-full">
      <SiteNavbar onLoginClick={() => navigate("/login")} />
      <Hero />
      <ExploreMenu />
      <FeaturedDishes />
      <TrustStrip />
