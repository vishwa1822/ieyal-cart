    ...
    <PageShell title="Search">
      <div className="px-4 lg:px-0 pt-4 lg:pt-0 pb-6 max-w-2xl lg:max-w-4xl mx-auto lg:mx-0 space-y-5">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={() => navigate(-1)}
            className="lg:hidden h-10 w-10 rounded-lg bg-surface border border-border flex items-center justify-center text-muted hover:text-primary hover:border-primary/40 transition-colors shrink-0"
          >
