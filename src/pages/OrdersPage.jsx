...
export default function OrdersPage() {
  ...
  return (
    <PageShell title="My Orders">
      <div className="px-4 lg:px-0 pt-4 lg:pt-0 pb-6 space-y-5 max-w-2xl lg:max-w-5xl mx-auto lg:mx-0">
        {/* Header */}
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold tracking-tight">My orders</h2>
            {totalOrders > 0 && (
              <p className="text-xs text-muted mt-0.5">{totalOrders} order{totalOrders !== 1 ? "s" : ""} total</p>
            )}
          </div>
        </div>
