            ...
            <div className="flex gap-2 justify-between" role="group" aria-label="One-time code">
              {digits.map((d, i) => (
                <input
                  ...
                  className="w-11 h-12 text-center text-lg font-semibold rounded-btn border-2 border-border focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all"
                />
              ))}
            </div>
