...
function QuickAction({ icon: Icon, label, sub, onClick }) {
  return (
    <button
      onClick={onClick}
      className="flex flex-col items-start gap-3 rounded-card lg:rounded-lg2 border border-border bg-surface p-4 text-left shadow-premium card-hover"
    >
      ...
      <div className="px-4 lg:px-0 pt-4 lg:pt-0 pb-4 max-w-2xl lg:max-w-5xl mx-auto lg:mx-0">
        <div className="lg:grid lg:grid-cols-[1fr_380px] lg:gap-8 lg:items-start space-y-5 lg:space-y-0">
          ...
          <div className="space-y-5">
            {/* Hero identity card */}
            <div className="relative overflow-hidden rounded-card lg:rounded-lg2 gradient-hero text-white p-5 lg:p-7 shadow-premium">
            ...
            <div>
              <p className="text-sm font-semibold mb-3 px-0.5">Quick actions</p>
          ...
          <div className="space-y-5">
            ...
            <div>
              <p className="text-sm font-semibold mb-2 px-0.5">Notification preferences</p>
              <div className="rounded-card lg:rounded-lg2 border border-border bg-surface shadow-premium px-4 divide-y divide-border">
                <PreferenceRow
                  icon={Bell}
            ...
            {/* Account list */}
            <div>
              <p className="text-sm font-semibold mb-2 px-0.5">Account</p>
              <div className="rounded-card lg:rounded-lg2 border border-border bg-surface shadow-premium px-4 divide-y divide-border">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-btn border border-danger/25 text-danger font-medium text-sm py-3 hover:bg-danger/5 transition-colors"
            >
              <LogOut className="h-4 w-4" /> Log out
            </button>

            <p className="text-center text-xs text-faint pb-2">OwnCart · v1.0.0</p>
          </div>
        </div>
      </div>
