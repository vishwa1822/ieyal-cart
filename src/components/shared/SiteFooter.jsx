      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-x-8 gap-y-14">
          ...
          <motion.div variants={fadeUp} className="col-span-2 md:col-span-4 pr-0 md:pr-8">
            <Link to="/home" className="iy-serif text-2xl tracking-tight font-medium text-[var(--iy-ink)]">IEYAL</Link>
          ...
          <div className="col-span-1 md:col-span-2">
            <FooterColumn title="Quick Links">
              <li><FooterLink to="/home#top">Home</FooterLink></li>
              <li><FooterLink to="/home#menu">Order Now</FooterLink></li>
              <li><FooterLink to="/home#dishes">Explore</FooterLink></li>
              <li><FooterLink to="/home#footer">Contact</FooterLink></li>
            </FooterColumn>
          </div>
